...
@synthesize isEnableRotate = _isEnableRotate;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.isEnableRotate = [[self objectOrNilForKey:kUserConfigIsShowTutorial fromDictionary:dict] boolValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithBool:self.isEnableRotate] forKey:kUserConfigIsShowTutorial];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.isEnableRotate = [aDecoder decodeBoolForKey:kUserConfigIsShowTutorial];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeBool:_isEnableRotate forKey:kUserConfigIsShowTutorial];
