...
@synthesize isScreenRotateLock = _isScreenRotateLock;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.isScreenRotateLock = [[self objectOrNilForKey:kUserConfigIsShowTutorial fromDictionary:dict] boolValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithBool:self.isScreenRotateLock] forKey:kUserConfigIsShowTutorial];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.isScreenRotateLock = [aDecoder decodeBoolForKey:kUserConfigIsShowTutorial];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeBool:_isScreenRotateLock forKey:kUserConfigIsShowTutorial];
