...
@objc class RemoteCommandDataSource: NSObject {
    
    let remoteCommandManager: RemoteCommandManager
    
    @objc init(remoteCommandManager: RemoteCommandManager) {
    ...
    @objc func toggleCommandHandler(with section: Int, row: Int, enable: Bool) {
