...
@objc  class RemoteCommandManager: NSObject {
    ...
    @objc init(assetPlaybackManager: AssetPlaybackManager) {
    ...
    #if os(tvOS)
    @objc func activateRemoteCommands(_ enable: Bool) {
    ...
    @objc func activatePlaybackCommands(_ enable: Bool) {
        if enable {
    ...
    @objc func toggleNextTrackCommand(_ enable: Bool) {
        if enable {
        }
        else {
        }
    ...
    @objc func togglePreviousTrackCommand(_ enable: Bool) {
        if enable {
        }
        else {
        }
    ...
    @objc func toggleSkipForwardCommand(_ enable: Bool, interval: Int = 0) {
        if enable {
...
//        remoteCommandCenter.skipForwardCommand.isEnabled = enable
    ...
    @objc func toggleSkipBackwardCommand(_ enable: Bool, interval: Int = 0) {
        if enable {
...
//        remoteCommandCenter.skipBackwardCommand.isEnabled = enable
    ...
    @objc func toggleSeekForwardCommand(_ enable: Bool) {
        if enable {
...
//        remoteCommandCenter.seekForwardCommand.isEnabled = enable
    ...
    @objc func toggleSeekBackwardCommand(_ enable: Bool) {
        if enable {
...
//        remoteCommandCenter.seekBackwardCommand.isEnabled = enable
    ...
    @objc func toggleChangePlaybackPositionCommand(_ enable: Bool) {
        if enable {
...
//        remoteCommandCenter.changePlaybackPositionCommand.isEnabled = enable
    ...
    @objc func toggleLikeCommand(_ enable: Bool) {
        if enable {
...
//        remoteCommandCenter.likeCommand.isEnabled = enable
    ...
    @objc func toggleDislikeCommand(_ enable: Bool) {
        if enable {
...
//        remoteCommandCenter.dislikeCommand.isEnabled = enable
    ...
    @objc func toggleBookmarkCommand(_ enable: Bool) {
        if enable {
