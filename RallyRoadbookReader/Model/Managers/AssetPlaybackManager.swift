...
@objc protocol AssetPlaybackManagerDelegate: AnyObject {
    func nextCalled()
    func prevCalled()
}

@objc class AssetPlaybackManager: NSObject {
    
    // MARK: Types
    @objc weak var delegate: AssetPlaybackManagerDelegate?
    ...
    override init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AssetPlaybackManager.handleAudioSessionInterruption(notification:)), name: NSNotification.Name(rawValue: AVAudioSession.interruptionNotification.rawValue), object: AVAudioSession.sharedInstance())
        #endif
    ...
    deinit {
        ...
        #if os(iOS)
        NotificationCenter.default.removeObserver(self, name: NSNotification.Name(rawValue: AVAudioSession.interruptionNotification.rawValue), object: AVAudioSession.sharedInstance())
        #endif
